...
const Navbar = () => {
  return (
      ...
      <div className='flex justify-between md:justify-end p-3 fixed bg-black items-center gap-2 md:gap-8 h-12  w-full left-0 top-0 z-40'>
        ...
        <a href='https://buy.stripe.com/5kA14k050a3Q5bycMM' className='text-sm font-poppins cursor-pointer text-gray-400 border border-red-600 rounded-md px-2 hover:border-b hover:border-b-yellow-700'>Buy now</a>
      </div>
