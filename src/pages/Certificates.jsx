  ...
  return (
    <div className='p-12'>
      ...
      <div className='flex gap-4 w-full'>
        <img onContextMenu="return false" className='w-1/2 border-4 rounded-md border-red-800' src="/assets/copyright/1.jpg" alt="Gmp Certificate" />
        <img className='w-1/2 border-4 rounded-md border-red-800' src="/assets/copyright/2.jpg" alt="haccp" />
      </div>
