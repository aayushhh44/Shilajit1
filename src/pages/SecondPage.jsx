  ...
  return (
    <div className="h-full p-4" id="product">
      ...
      <h2 className="text-center uppercase p-2 font-rubik text-gray-600 md:tex-2xl">
        Experience the Himalayan magic in every drop of our Shilajit – straight
        from Nepal's heart to yours
      </h2>
          ...
          <div className="p-4">
            <ul className="md:text-2xl text-gray-600">
              <div className="flex items-center gap-4">
                <FaLeaf />
                <p className="text-nowrap">Boosts libido and sexual performance</p>
              </div>
              <div className="flex items-center gap-4">
                <FaLeaf />
              ...
              <div className="flex items-center gap-4">
                <FaLeaf />
                <p className="text-wrap">Supports bone density and joint health</p>
              </div>
              <div className="flex items-center gap-4">
                <FaLeaf />
                <p className="text-wrap">Aids digestion and promotes gut health</p>
              </div>
              <div className="flex items-center gap-4">
                <FaLeaf />
                <p className="text-wrap">Supports male fertility and reproductive function</p>
              </div>
            </ul>
          </div>
        </div>
